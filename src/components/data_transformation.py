...
class Data_Transformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            train_df=pd.read_csv(r'C:\Users\DELL\Desktop\ML project\src\components\artifact\train.csv')
            test_df=pd.read_csv(r'C:\Users\DELL\Desktop\ML project\src\components\artifact\test.csv')
